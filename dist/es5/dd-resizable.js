...
var DDResizable = exports.DDResizable = /** @class */ (function (_super) {
    ...
    DDResizable.prototype._applyChange = function () {
        ...
        if (!this.temporalRect)
            return this;
        var scaleX = (_b = utils_1.Utils.getScaleForElement(this.el), _b.scaleX), scaleY = _b.scaleY;
        this.el.style.width = "".concat(this.temporalRect.width / scaleX, "px");
        this.el.style.height = "".concat(this.temporalRect.height / scaleY, "px");
        this.el.style.top = "".concat(this.temporalRect.top / scaleY, "px");
        this.el.style.left = "".concat(this.temporalRect.left / scaleX, "px");
        return this;
    };
    /** @internal */
