...
var DDDraggable = exports.DDDraggable = /** @class */ (function (_super) {
    ...
    DDDraggable.prototype._dragFollow = function (e) {
        ...
        var parentOfItem = utils_1.Utils.getContainerOfGridStackItem(this.helper) || document.documentElement;
        var transformParent = utils_1.Utils.getContainerForPositionFixedElement(parentOfItem);
        var scrollParent = utils_1.Utils.getScrollElement(this.helper);
        // We need to be careful here as the html element actually also includes scroll
        // so in this case we always need to ignore it
        var transformParentRect = transformParent !== document.documentElement ? transformParent.getBoundingClientRect() : { top: 0, left: 0 };
        ...
        var scroll = transformParent === scrollParent && transformParent !== document.documentElement
        ...
        var x = (e.clientX - offsetX - (((_b = this.origRelativeMouse) === null || _b === void 0 ? void 0 : _b.x) || 0)) / scaleX + scroll.left;
        var y = (e.clientY - offsetY - (((_c = this.origRelativeMouse) === null || _c === void 0 ? void 0 : _c.y) || 0)) / scaleY + scroll.top;
    ...
    DDDraggable.prototype.ui = function () {
        ...
        var scaleX = (_a = utils_1.Utils.getScaleForElement(this.helper), _a.scaleX), scaleY = _a.scaleY;
        var scroll = containmentEl.contains(scrollElement) ? scrollElement : { scrollTop: 0, scrollLeft: 0 };
        return {
            position: {
